...
?>
<article class="post-card is-hero-blog-post" data-post-id="<?php echo $postID; ?>">
    <div class="card-img">
        <?php 
    ...
    <div class="card-body">
        <div class="card-content">
            <div class="post-meta">
                <span class="post-date"><?php echo get_the_date( 'M d, Y', $postID ); ?> </span><span>|</span><span class="post-read-time"><?php echo round(str_word_count(get_the_content($postID)) / 300); ?> min read</span>
            </div>
