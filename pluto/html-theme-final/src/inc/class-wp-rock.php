...
class WP_Rock {
    ...
    public function px_get_youtube_embed_url( $youtube_url ) {
        ...
        $long_url_regex  = '/youtube\.com\/(?:embed|watch|shorts)(?:\?v=|\/)([a-zA-Z0-9_-]+)/i';
        ...
        // Check "shorts"
        if ( ! $youtube_id && preg_match( $short_url_regex, $youtube_url, $matches ) ) {
            $youtube_id = $matches[1];
        }
    ...
    public function px_site_setup() {
        ...
        register_nav_menus(
            array(
                ...
                'footer_policies_menu'  => __( 'Policies Menu', 'wp-rock' ),
